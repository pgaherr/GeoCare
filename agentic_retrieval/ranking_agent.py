...
DB_PATH = Path(__file__).parent / "data" / "output" / "facilities_20260207_2219.db"
...
def _get_facility_profiles(pk_ids: list[int], db_path: Path = DB_PATH) -> list[dict]:
    ...
    # Get facility base data
    rows = conn.execute(
        f"SELECT pk_unique_id, name, description, specialties, procedure, capability, officialWebsite "
